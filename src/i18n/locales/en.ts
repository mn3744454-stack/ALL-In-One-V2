export const en = {
  ...
  notifications: {
    ...
    events: {
      "connection.request_received": { title: "New Partnership Request", body: "{{actorTenantName}} wants to connect" },
      "connection.accepted": { title: "Partnership Accepted", body: "{{actorTenantName}} accepted your request" },
      "connection.rejected": { title: "Partnership Declined", body: "{{actorTenantName}} declined your request" },
      "lab_request.new": { title: "New Lab Request", body: "{{actorTenantName}} · {{entityLabel}}" },
      "lab_request.status_changed": { title: "Lab Request Updated", body: "{{actorTenantName}} · {{statusLabel}}" },
      "lab_request.result_published": { title: "Lab Results Available", body: "{{actorTenantName}} · {{entityLabel}}" },
      "lab_request.message_added": { title: "New Message", body: "{{actorTenantName}} · {{messagePreview}}" },
      "boarding.admission_created": { title: "Horse Admitted", body: "{{horseName}} admitted to boarding" },
      "boarding.checkout_initiated": { title: "Checkout Initiated", body: "{{horseName}} · checkout started" },
      "boarding.checkout_completed": { title: "Horse Checked Out", body: "{{horseName}} checked out" },
      "movement.scheduled": { title: "Departure Scheduled", body: "{{horseName}} · departure scheduled" },
      "movement.dispatched": { title: "Horse Dispatched", body: "{{horseName}} dispatched" },
      "movement.incoming_pending": { title: "Incoming Horse", body: "From {{actorTenantName}} · {{horseName}}" },
      "movement.incoming_confirmed": { title: "Arrival Confirmed", body: "{{actorTenantName}} confirmed arrival · {{horseName}}" },
    },
  },
  doctor: {

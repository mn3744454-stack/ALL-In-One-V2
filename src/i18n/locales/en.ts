export const en = {
  ...
  movement: {
    ...
    wizard: {
      step1Title: "Select Type",
      step1Desc: "What kind of movement?",
      step2Title: "Select Horse",
      step2Desc: "Which horse is moving?",
      step3Title: "Select Location",
      step3Desc: "Where is the horse going?",
      step4Title: "Additional Details",
      step4Desc: "Add reason and notes",
      step5Title: "Review",
      step5Desc: "Confirm the movement details",

export const en = {
  ...
  finance: {
    ...
    pos: {
      title: "Point of Sale",
      subtitle: "Quick sales and payment processing",
      comingSoon: "Point of Sale Coming Soon",
      comingSoonDesc: "We're building a comprehensive POS system. Stay tuned for quick sales, session management, and receipt printing.",
      plannedFeatures: "Planned Features",
      features: {
        sessions: "Session Management",
        sessionsDesc: "Open and close cash sessions with balance tracking",
        quickSale: "Quick Sales",
        quickSaleDesc: "Fast checkout for walk-in customers",
        payments: "Multiple Payment Methods",
        paymentsDesc: "Accept cash, card, and bank transfers",
        receipts: "Receipt Printing",
        receiptsDesc: "Print or email receipts instantly",
        customers: "Customer Lookup",
        customersDesc: "Quick access to customer history",
        inventory: "Service Catalog",
        inventoryDesc: "Link to your services and products",
      },
    },
    categories: {

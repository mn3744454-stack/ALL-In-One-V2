export const ar = {
  ...
  laboratory: {
    ...
    templates: {
      ...
      groupNameArPlaceholder: "أدخل اسم المجموعة بالعربية",
      ...
      fieldNameArPlaceholder: "أدخل اسم الحقل بالعربية",
      fieldType: "نوع الحقل",
      ...
      discountNameArPlaceholder: "أدخل اسم الخصم بالعربية",
      discountType: "النوع",
      ...
      ruleNameArPlaceholder: "أدخل اسم القاعدة بالعربية",
      condition: "الشرط",

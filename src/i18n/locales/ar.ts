export const ar = {
  ...
  notifications: {
    ...
    events: {
      "connection.request_received": { title: "طلب شراكة جديد", body: "{{actorTenantName}} يريد الاتصال" },
      "connection.accepted": { title: "تم قبول الشراكة", body: "{{actorTenantName}} قبل طلبك" },
      "connection.rejected": { title: "تم رفض الشراكة", body: "{{actorTenantName}} رفض طلبك" },
      "lab_request.new": { title: "طلب مختبر جديد", body: "{{actorTenantName}} · {{entityLabel}}" },
      "lab_request.status_changed": { title: "تحديث طلب المختبر", body: "{{actorTenantName}} · {{statusLabel}}" },
      "lab_request.result_published": { title: "نتائج المختبر متاحة", body: "{{actorTenantName}} · {{entityLabel}}" },
      "lab_request.message_added": { title: "رسالة جديدة", body: "{{actorTenantName}} · {{messagePreview}}" },
      "boarding.admission_created": { title: "تم إدخال حصان", body: "{{horseName}} تم إدخاله للإيواء" },
      "boarding.checkout_initiated": { title: "بدء إجراء الخروج", body: "{{horseName}} · بدأ إجراء الخروج" },
      "boarding.checkout_completed": { title: "تم خروج الحصان", body: "{{horseName}} غادر الإيواء" },
      "movement.scheduled": { title: "تم جدولة المغادرة", body: "{{horseName}} · تمت جدولة المغادرة" },
      "movement.dispatched": { title: "تم إرسال الحصان", body: "{{horseName}} تم إرساله" },
      "movement.incoming_pending": { title: "حصان قادم", body: "من {{actorTenantName}} · {{horseName}}" },
      "movement.incoming_confirmed": { title: "تم تأكيد الوصول", body: "{{actorTenantName}} أكد الوصول · {{horseName}}" },
    },
  },
  doctor: {

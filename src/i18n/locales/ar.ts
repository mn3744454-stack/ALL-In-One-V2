export const ar = {
  ...
  organizationSettings: {
    ...
    taxPricing: {
      title: "الضريبة والتسعير",
      description: "إعدادات الضريبة الافتراضية على مستوى المنشأة للفواتير والفوترة",
      ...
      saving: "جارٍ الحفظ...",
      savedSuccess: "تم حفظ إعدادات الضريبة بنجاح",
      savedError: "فشل في حفظ إعدادات الضريبة",
    },
  },
  schedule: {
    title: "الجدول",

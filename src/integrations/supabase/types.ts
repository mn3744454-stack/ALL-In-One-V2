  ...
  public: {
    Tables: {
      ...
      hr_employee_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "hr_employee_events_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "hr_employees"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hr_employee_events_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "public_tenant_directory"
            referencedColumns: ["id"]
      ...
      supplier_payables: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "supplier_payables_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "public_tenant_directory"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      confirm_incoming_movement: {
        Args: { p_branch_id?: string; p_incoming_id: string; p_notes?: string }
        Returns: Json
      }

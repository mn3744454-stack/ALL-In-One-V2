  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0 pb-20 lg:pb-0">
        <MobilePageHeader title="Consultations" />
        <header className="hidden lg:flex items-center justify-between h-16 px-6 border-b bg-background/95 backdrop-blur">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold flex items-center gap-2"><ClipboardList className="h-5 w-5" />Consultations</h1>
          </div>
          <NotificationsPanel />
        </header>
        ...
        <div className="container mx-auto px-4 py-6 max-w-7xl">
          ...
          {loading ? (
            ...
            <Card><CardContent className="py-12 text-center text-muted-foreground">No consultations found.</CardContent></Card>
          ) : (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          <p className="font-medium">{c.horse_name_snapshot || "Unknown Patient"}</p>
                        ...
                        <p className="text-sm text-muted-foreground mt-1 truncate">{c.chief_complaint || "No complaint recorded"}</p>
                      </div>

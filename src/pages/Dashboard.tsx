...
const Dashboard = () => {
  ...
  return (
    <DashboardShell>
      {/* Mobile Header — Dashboard home has its own mobile header with workspace toggle */}
      <header className="lg:hidden shrink-0 z-30 bg-cream/80 backdrop-blur-xl border-b border-border/50">
        {/* Row 1: Workspace toggle + actions */}
                ...
                <Card variant="elevated">
                  ...
                  <CardContent className="space-y-3">
                    {isHorseOwningTenant && (
                      <AddHorseDialog
                        trigger={
                          <button className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-muted/50 transition-colors text-start">
                            <div className="w-10 h-10 rounded-xl bg-gold/10 flex items-center justify-center">
                              <Heart className="w-5 h-5 text-gold" />
                            </div>
                            <div>
                              <p className="font-medium text-navy">{t("dashboard.addNewHorse")}</p>
                              <p className="text-sm text-muted-foreground">{t("dashboard.registerHorse")}</p>
                            </div>
                          </button>
                        }
                      />
                    ...
                    <Link to="/dashboard/schedule">
                      <button className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-muted/50 transition-colors text-start">
                        ...
                        <div>
                          <p className="font-medium text-navy">{t("dashboard.scheduleCheckup")}</p>
                          <p className="text-sm text-muted-foreground">{t("dashboard.bookAppointment")}</p>
                        </div>
                      </button>
                    </Link>
                    <Link to="/dashboard/settings">
                      <button className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-muted/50 transition-colors text-start">
                        ...
                        <div>
                          <p className="font-medium text-navy">{t("sidebar.settings")}</p>
                          <p className="text-sm text-muted-foreground">{t("dashboard.manageTeam")}</p>
                        </div>
                      </button>
                    </Link>
                  </CardContent>

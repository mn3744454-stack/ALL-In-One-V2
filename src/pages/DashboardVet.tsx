...
const mockTreatments = [
  { id: "mock-treat-1", horse: { id: "h1", name: "الأصيل", avatar_url: null }, category: "treatment" as const, title: "Respiratory Infection Treatment", description: "Treatment for mild respiratory infection", status: "in_progress" as const, priority: "high" as const, service_mode: "external" as const, external_provider: { id: "p1", name: "Dr. Ahmed" }, scheduled_for: new Date(Date.now() + 2 * 86400000).toISOString(), created_at: new Date(Date.now() - 3 * 86400000).toISOString(), tenant_id: "t1", created_by: "u1", updated_at: new Date().toISOString(), notes: "Monitoring daily", assigned_to: null, completed_at: null },
  { id: "mock-treat-2", horse: { id: "h2", name: "الفارس", avatar_url: null }, category: "dental" as const, title: "Annual Dental Float", description: "Routine dental floating", status: "scheduled" as const, priority: "medium" as const, service_mode: "external" as const, external_provider: { id: "p2", name: "Equine Dental" }, scheduled_for: new Date(Date.now() + 5 * 86400000).toISOString(), created_at: new Date(Date.now() - 86400000).toISOString(), tenant_id: "t1", created_by: "u1", updated_at: new Date().toISOString(), notes: null, assigned_to: null, completed_at: null },
];

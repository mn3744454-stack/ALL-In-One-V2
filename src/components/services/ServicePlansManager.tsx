...
export function ServicePlansManager() {
  ...
  const openCreate = () => {
    setEditing(null);
    setIncludedServices([]);
    setForm({ name: '', name_ar: '', description: '', service_id: null, plan_type: 'boarding', billing_cycle: 'monthly', base_price: 0, currency: tenantCurrency, is_active: true, is_public: false });
    setDialogOpen(true);
  };
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Label>{t('services.packages.public')}</Label>
              </div>
            </div>

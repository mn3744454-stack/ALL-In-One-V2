...
import { Printer, FileText, CheckCircle2, X } from "lucide-react";
      ...
      <DialogContent className={cn(
        ...
        <DialogHeader>
          <DialogTitle className={cn(
            ...
            {t("finance.pos.receipt.success", "Sale Complete")}
          </DialogTitle>
        </DialogHeader>
        ...
        <div id="pos-receipt" className="print-content space-y-3 p-4 bg-muted/30 rounded-lg">
          ...
          <div className="text-center">
            <p className="font-bold text-lg">{t("finance.pos.receipt.title", "Receipt")}</p>
          ...
          {invoice.client_name && (
            <p className="text-sm">
              <span className="text-muted-foreground">
                {t("finance.pos.customer", "Customer")}:
              </span>{" "}
              {invoice.client_name}
            </p>
          )}
          ...
          {invoice.payment_method && (
            <p className="text-center text-sm text-muted-foreground">
              {t(`finance.pos.payment.${invoice.payment_method}`, invoice.payment_method)}
            </p>
          )}
        </div>
        ...
        <div className="flex flex-col gap-2 mt-2">
          <div className={cn("flex gap-2", isRTL && "flex-row-reverse")}>
            ...
            >
              ...
              {t("finance.pos.actions.print", "Print")}
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              {t("finance.pos.actions.viewInvoice", "View Invoice")}
            </Button>
          </div>
          <Button
            onClick={onNewSale}
          ...
          >
            {t("finance.pos.actions.newSale", "New Sale")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>

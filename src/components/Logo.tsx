  ...
  return (
    <Link to="/" className={`flex items-center gap-2 ${className}`}>
      <div className="relative">
        <div className={`${isSmall ? "w-8 h-8" : "w-10 h-10"} rounded-xl bg-gradient-to-br from-gold to-gold-light flex items-center justify-center shadow-gold`}>
          <svg
            viewBox="0 0 24 24"
            className={`${isSmall ? "w-5 h-5" : "w-6 h-6"} text-navy`}
            fill="currentColor"
          >

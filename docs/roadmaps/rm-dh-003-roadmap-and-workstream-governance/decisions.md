...
- Canonical repository Decision IDs are therefore **consecutive**: `DEC-RM-DH-003-001`, `DEC-RM-DH-003-002`, `DEC-RM-DH-003-003`.
- Each canonical ID retains its original owner-alignment label as an alias.

...
| `DHB-R01-DEV` | Round 1 — Platform Foundation, Architecture, Database, Tenancy, Authentication, Permissions, Storage, Edge Functions, and Environment | `docs/handoff/rounds/round-01/round-01-developer-handoff.md` | handoff-round-canonical | external-developer | canonical-pending-owner-acceptance | 1.1.0 | DG.3 (authored), DG.3A (content correction) | canonical Round 1 external-developer handoff | — | — | acceptance file pending | pending owner acceptance |
| `DHB-R01-INT` | Round 1 — Internal Lovable Reference | `docs/handoff/rounds/round-01/round-01-lovable-reference.md` | handoff-round-internal | internal-lovable | supporting-pending-owner-acceptance | 1.1.0 | DG.3 (authored), DG.3A (alignment) | internal-facing condensed Round 1 companion to DHB-R01-DEV | — | — | acceptance file pending | pending owner acceptance |

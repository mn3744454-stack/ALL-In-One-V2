...
BEGIN
  ...
  IF v_incoming.source_type = 'boarding_contract' THEN
    ...
    -- Receiving branch is REQUIRED at confirm time; preferred branch on contract is preference only.
    ...
    -- Local arrival movement (with explicit destination branch — satisfies chk_movement_in).
